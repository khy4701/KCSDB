...
public abstract class Connector2 implements Runnable {
	private static Logger logger = LogManager.getLogger(Connector2.class);
	...
	public Connector2(String ipAddr, int port) {
	...
	public Connector2(CommandReceiver receiver, String ipAddr, int port) {
 ...
 */
	public Connector2(ConnectObserver connectObserver, CommandReceiver receiver, String ipAddr, int port) {
